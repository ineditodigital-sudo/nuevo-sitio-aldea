...
echo '<input name="email" type="email" required placeholder="Correo corporativo" data-ph-es="Correo corporativo" data-ph-en="Work email" autocomplete="email"></div>';
...
echo '</select>';
echo '<label class="cf-month"><span data-es="Fecha objetivo de operación" data-en="Target move-in date">Fecha objetivo de operación</span><input name="target_date" type="month"></label>';
echo '</div>';
