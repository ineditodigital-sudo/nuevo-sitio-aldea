...
echo '<figure class="duo-media tall">'.pic('/img/sedes/leon/lounge.webp','Áreas comunes de Aldea','(max-width:900px) 100vw, 58vw','loading="lazy"').'</figure><div class="duo-copy">';
